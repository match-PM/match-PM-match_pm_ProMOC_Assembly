...
def test_error_code_ranges_are_grouped() -> None:
    ...
    assert 1000 <= error_codes.CONTROLLER_NOT_CONNECTED < 1100
    assert 1100 <= error_codes.INVALID_CONFIGURATION < 1200
    assert 1100 <= error_codes.INVALID_COMMAND < 1200
    assert 1200 <= error_codes.DEVICE_NOT_READY < 1300
    assert 1200 <= error_codes.XBOT_NOT_FOUND < 1300
    assert 1200 <= error_codes.XBOT_NOT_ACTIVE < 1300
    assert 1200 <= error_codes.POSITION_UNAVAILABLE < 1300
    assert 1200 <= error_codes.DRIVER_FAILURE < 1300
    ...
    assert 1600 <= error_codes.MOVEMENT_STOPPED < 1700
