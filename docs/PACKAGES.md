...
| `planar_motor_nodes` | mover motion and control services | `/promoc/mover/activate_xbots` | `planar_motor_nodes/planar_motor_nodes/mover_node.py` and [`../planar_motor_nodes/README.md`](../planar_motor_nodes/README.md) |
...
| mover hardware integration | `planar_motor_nodes/planar_motor_nodes/mover_pmc_interface.py` |
