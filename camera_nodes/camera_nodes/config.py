...
ALL_PARAM_VALUES: tuple[tuple[str, object], ...] = (
    ...
    ("autofocus.analysis_roi_x_px", -1),
    ("autofocus.analysis_roi_y_px", -1),
    ...
    ("mtf.profile", "default"),
    ("mtf_min_edge_angle", 2.0),
    ("mtf_max_edge_angle", 11.0),
    ...
    ("mtf.capture_only_samples", 10),
    ("mtf.capture_only_timeout_s", 1.0),
    ("mtf.capture_only_context_margin_px", 64),
    ("mtf.capture_only_save_fullframe_raw", True),
    ("mtf.capture_only_preview_png", True),
...
_GROUP_SPECS: dict[str, tuple[tuple[str, str, type, object], ...]] = {
    ...
    "autofocus": (
        ...
        ("autofocus.analysis_roi_x_px", "analysis_roi_x_px", int, -1),
        ("autofocus.analysis_roi_y_px", "analysis_roi_y_px", int, -1),
        ("autofocus.analysis_roi_width_px", "analysis_roi_width_px", int, 2048),
        ("autofocus.analysis_roi_height_px", "analysis_roi_height_px", int, 2048),
        (
    ...
    "mtf": (
        ...
        ("mtf.capture_only_samples", "capture_only_samples", int, 10),
        ("mtf.capture_only_timeout_s", "capture_only_timeout_s", float, 1.0),
        (
            "mtf.capture_only_context_margin_px",
            "capture_only_context_margin_px",
            int,
            64,
        ),
        (
    ...
    "auto_exposure": (
        ("auto_exposure.target_level_fraction", "target_level_fraction", float, 0.70),
        ...
        (
            "auto_exposure.clipping_level_fraction",
            "clipping_level_fraction",
            float,
            0.95,
        ),
