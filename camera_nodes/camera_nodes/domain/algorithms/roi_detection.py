...
class RoiDetector:
    ...
    def filter_by_contrast(
        targets: List[DetectedTarget], min_contrast: float = MIN_CONTRAST_THRESHOLD
    ) -> List[DetectedTarget]:
        """
    ...
    @staticmethod
    def split_square_into_edges(
        image: np.ndarray, square_rect: tuple
    ) -> List[np.ndarray]:
        """
    ...
    @staticmethod
    def split_square_into_edges_with_contrast(
        image: np.ndarray,
        square_rect: tuple,
    ...
    @staticmethod
    def split_square_into_edges_with_boxes(
        image: np.ndarray,
        square_rect: tuple,
