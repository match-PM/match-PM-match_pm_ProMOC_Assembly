...
#ifndef PROMOC_ASSEMBLY_INTERFACES__SRV__DETAIL__ARC_MOTION__FUNCTIONS_H_
#define PROMOC_ASSEMBLY_INTERFACES__SRV__DETAIL__ARC_MOTION__FUNCTIONS_H_
...
/// Initialize srv/ArcMotion message.
/**
...
/// Finalize srv/ArcMotion message.
/**
...
/// Create srv/ArcMotion message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * promoc_assembly_interfaces__srv__ArcMotion_Request__init().
...
/// Destroy srv/ArcMotion message.
/**
 * It calls
 * promoc_assembly_interfaces__srv__ArcMotion_Request__fini()
...
/// Check for srv/ArcMotion message equality.
/**
...
/// Initialize array of srv/ArcMotion messages.
/**
...
/// Finalize array of srv/ArcMotion messages.
/**
 * It calls
 * promoc_assembly_interfaces__srv__ArcMotion_Request__fini()
...
/// Create array of srv/ArcMotion messages.
/**
 * It allocates the memory for the array and calls
 * promoc_assembly_interfaces__srv__ArcMotion_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ArcMotion messages.
/**
 * It calls
 * promoc_assembly_interfaces__srv__ArcMotion_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ArcMotion message array equality.
/**
...
/// Copy an array of srv/ArcMotion messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * promoc_assembly_interfaces__srv__ArcMotion_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_promoc_assembly_interfaces
...
/**
 * It calls
 * promoc_assembly_interfaces__srv__ArcMotion_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_promoc_assembly_interfaces
...
/**
 * It allocates the memory for the array and calls
 * promoc_assembly_interfaces__srv__ArcMotion_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_promoc_assembly_interfaces
...
/**
 * It calls
 * promoc_assembly_interfaces__srv__ArcMotion_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PROMOC_ASSEMBLY_INTERFACES__SRV__DETAIL__ARC_MOTION__FUNCTIONS_H_
