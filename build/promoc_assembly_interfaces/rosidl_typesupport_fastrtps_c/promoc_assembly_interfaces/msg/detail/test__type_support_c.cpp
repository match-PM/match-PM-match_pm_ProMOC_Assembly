...
#include "promoc_assembly_interfaces/msg/detail/test__rosidl_typesupport_fastrtps_c.h"
...
using _Test__ros_msg_type = promoc_assembly_interfaces__msg__Test;
...
static uint32_t _Test__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_promoc_assembly_interfaces__msg__Test(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = promoc_assembly_interfaces__msg__Test;
    is_plain =
      (
...
static size_t _Test__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_promoc_assembly_interfaces__msg__Test(
